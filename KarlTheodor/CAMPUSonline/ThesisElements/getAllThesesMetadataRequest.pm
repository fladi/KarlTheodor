...
package CAMPUSonline::ThesisElements::getAllThesesMetadataRequest;
use strict;
use warnings;
...
__PACKAGE__->__set_name('getAllThesesMetadataRequest');
...
CAMPUSonline::ThesisElements::getAllThesesMetadataRequest

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
getAllThesesMetadataRequest from the namespace http://www.campusonline.at/thesisservice/basetypes.
...
=head2 new
 ...
 my $element = CAMPUSonline::ThesisElements::getAllThesesMetadataRequest->new($data);
